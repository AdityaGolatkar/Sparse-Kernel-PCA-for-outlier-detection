# -*- coding: utf-8 -*-
"""
Created on Sat Jan 13 01:26:43 2018
...
def main():
	points_per_digit = 300
	testpoints_per_samedigit = 111
	...
	inliers = np.load('apple.npy')
	outliers = np.load('tomato.npy') 
	...
	idx = np.random.choice(inliers.shape[0],points_per_digit+testpoints_per_samedigit,replace=False) 	
	data = inliers[idx[0:points_per_digit],0:]
	...
	test_data_same = inliers[idx[points_per_digit:points_per_digit+testpoints_per_samedigit],0:]
    
	testpoints_per_diffdigit = 111
