# -*- coding: utf-8 -*-
"""
Created on Sat Dec 23 00:57:03 2017
...
def main():
	...
	#for 6 
	#gamma = 1/(2*6639809.12595)
	#for 3
	#gamma = 1/(2*4560255.77688)
	#for 1 
	#gamma = 1/(2*3348199.75142)
	#for 0
	#gamma = 1/(2*1050.8280595)
	#for 4
	#gamma = 1/(2*5526364.59967)
	#for 5
	#gamma = 1/(2*5052862.56713)
	#for 9
	...
	diffdata1 = np.append(one[0:testpoints_per_diffdigit,0:],two[0:testpoints_per_diffdigit,0:],axis=0)
	diffdata2 = np.append(zero[0:testpoints_per_diffdigit,0:],three[0:testpoints_per_diffdigit,0:],axis=0)
	diffdata3 = np.append(four[0:testpoints_per_diffdigit,0:],six[0:testpoints_per_diffdigit,0:],axis=0)  
	...
	test_data_diff = np.append(test_data_diff,five[0:testpoints_per_diffdigit,0:],axis=0)
