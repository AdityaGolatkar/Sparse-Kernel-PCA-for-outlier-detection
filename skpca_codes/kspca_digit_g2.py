# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 01:41:16 2017
...
def main():
	...
	threshold = threshold_0n
	
	data = zero[0:points_per_digit,0:]
	...
	test_data_same = zero[points_per_digit:points_per_digit+testpoints_per_samedigit,0:]
    
	testpoints_per_diffdigit = 50
	diffdata1 = np.append(six[0:testpoints_per_diffdigit,0:],two[0:testpoints_per_diffdigit,0:],axis=0)
	diffdata2 = np.append(three[0:testpoints_per_diffdigit,0:],four[0:testpoints_per_diffdigit,0:],axis=0)
	diffdata3 = np.append(five[0:testpoints_per_diffdigit,0:],one[0:testpoints_per_diffdigit,0:],axis=0)  
	...
	test_data_diff = np.append(test_data_diff,nine[0:testpoints_per_diffdigit,0:],axis=0)
